...
<html xmlns="http://www.w3.org/1999/xhtml,http://open.weibo.com/wb">
  ...
  <body id="top_banner" style="padding:0px; margin:0px; background:url(${sessionBianjizhuanqutoubu})  center 0px no-repeat #f0f0f0;">
  	<jsp:include page="other_head.jsp" flush="false" />
	<div class="main_2_div">
		<div class="div_title_css_main">
			<div class="div_title_css_sec">编辑专区
				<c:if test="${not empty loginUsers }">
					[<a href="<%=request.getContextPath()%>/wangbian_apply.jsp">申请成为网编</a>]
				</c:if>
			</div>
			<div class="div_title_css_conetent">
				${otherContent.bianjizhuanqu }
			</div>
		</div>
	</div>
	<jsp:include page="interactive.jsp" flush="false">
		<jsp:param value="0" name="interactivetype"/>
	</jsp:include>
