...
<div class="divInit">
	...
	<form id="AnzhiWebEditorSignForm" action="anzhiwebeditor/findAnzhiWebEditorById.do?anzhiwebeditorId=${param.anzhiwebeditorId}&&editorId=${param.editorId }" method="post">
		<div class="tableCss">
			...
			<jsp:include page="../next_page.jsp" flush="false">
				<jsp:param value="anzhiwebeditor/findAnzhiWebEditorById.do?anzhiwebeditorId=${param.anzhiwebeditorId}&&editorId=${param.editorId }" name="url"/>
