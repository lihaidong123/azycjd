...
<form class="formCss" method="post" id="AnzhiCommentFormManageAdmin" action="anzhicomment/anzhiCommentAllManageAdmin.do?tableId=${param.tableId }">
	...
	<div class="searchItemsCssss" style="background-color: #ffffff;border: none;border-bottom: #f0f0f0 1px solid;">
		...
		<div style="clear: both;">
			<input class="searchBtnCss" type="button" value="查询" onclick="direcNum('anzhicomment/anzhiCommentAllManageAdmin.do?tableId=${param.tableId }','AnzhiCommentFormManageAdmin')"/>
		</div>
	</div>
	...
	<jsp:include page="../next_page.jsp" flush="false">
		<jsp:param value="anzhicomment/anzhiCommentAllManageAdmin.do?tableId=${param.tableId }" name="url"/>
...
<script type="text/javascript">
	$(function(){
		$("#AnzhiCommentFormManageAdmin").bind('keydown', function (e) {
	        var key = e.which;
	        if (key == 13) {
	            direcNum("anzhicomment/anzhiCommentAllManageAdmin.do?tableId=${param.tableId }","AnzhiCommentFormManageAdmin");
	        }
	    });
	});
</script>