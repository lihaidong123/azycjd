...
<jsp:include page="index_head.jsp" flush="false"></jsp:include>
	...
	<form class="formCss" id="day_registration_form">
		<div class="htmlTitleCss">
			<div class="htmlTitleCsss_one">每日评论</div>
		</div>
		<div class="second_title_css">
			<input class="addBtnCss" type="button" value="点我评论" onclick="window.location.href='<%=request.getContextPath()%>/index/add_day_comments.jsp?linenumber=18'" /><font style="padding-left:20px;">每日第一条书评，5个经验值</font>
		</div>
