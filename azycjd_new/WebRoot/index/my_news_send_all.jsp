...
<script type="text/javascript">
		function showDivFn(id){
		 ...
		 <div class="divTableCss">
		 	<form id="AnzhiMessageFormIndex" action="anzhimessage/findAnzhiMessageAll.do?pageName=${param.pageName }&&linenumber=${param.linenumber }&&index=4&&chooseIndex=2" method="post" class="formCss">
				 ...
				 <jsp:include page="../next_page.jsp" flush="false">
					<jsp:param value="anzhimessage/findAnzhiMessageAll.do?pageName=index/my_news_send_all&&linenumber=${param.linenumber }&&index=4&&chooseIndex=2" name="url"/>
