	...
	KindEditor.ready(function(K) {
		...
		editor1 = K.create('textarea[class="htmlEditCss"]', {
			...
			afterChange : function() {
				try{
					parent.document.getElementById("chapterContent").value=this.html();
					parent.document.getElementById("chapterCharNum").value=this.count('text');
					parent.document.getElementById("totalcharnum").innerHTML="总共["+this.count('text')+"]字";
				}catch(e){}
			},
