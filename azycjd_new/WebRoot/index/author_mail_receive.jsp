...
<script type="text/javascript">
		function showDivFn(divid,id,obj,messageRead){
		 ...
		 <div class="divTableCss">
		 	<form id="AnzhiMessageFormIndex" action="anzhimessage/findAnzhiMessageAll.do?pageName=${param.pageName }&&linenumber=${param.linenumber }&&index=9&&chooseIndex=0" method="post" class="formCss">
				 ...
				 <jsp:include page="../next_page.jsp" flush="false">
					<jsp:param value="anzhimessage/findAnzhiMessageAll.do?pageName=index/author_mail_receive&&linenumber=${param.linenumber }&&index=9&&chooseIndex=0" name="url"/>
