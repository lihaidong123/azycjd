...
<jsp:include page="index_head.jsp" flush="false"></jsp:include>
	...
	<form class="formCss" id="day_registration_form">
		<div class="htmlTitleCss">
			<div class="htmlTitleCsss_one">每日广播</div>
		</div>
		<div class="second_title_css">
			<input class="addBtnCss" type="button" value="点我广播" onclick="window.location.href='<%=request.getContextPath()%>/index/add_day_broadcast.jsp?linenumber=13'" /><font style="padding-left:20px;">每日前三条广播有经验值，一条2个经验值</font>
		</div>
