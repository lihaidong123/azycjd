...
<jsp:include page="index_head.jsp" flush="false"></jsp:include>
	...
	<form class="formCss" id="day_registration_form">
		<div class="htmlTitleCss">
			<div class="htmlTitleCsss_one">每日充值</div>
		</div>
		<div class="second_title_css" style="height: auto;">
			<div><input class="addBtnCss" type="button" value="点我充值" onclick="window.location.href='<%=request.getContextPath()%>/index/add_day_recharge.jsp?linenumber=15'" /></div>
