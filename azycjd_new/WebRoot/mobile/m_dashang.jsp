...
<style type="text/css">
	...
	.bangdan_css div{line-height:50px;}
	.bangdan_items { padding:8px; display:none;  font-famil:font: 12px/160% Tahoma, Verdana,snas-serif !important; font-size:12px; color:#666666;}
	.bangdan_items div{margin-top: 10px; clear: both;overflow: auto;}
	.bangdan_items strong{margin-left: 5px; margin-right: 5px;}
	.bangdan_items ul{ list-style:none; margin:0px; padding:0px;}
	.bangdan_items li{ float:left; margin-left:10px; margin-top: 10px;}
	...
	.add_da_shang{cursor:pointer; width:85px; letter-spacing:3px; font-family:"黑体"; font-size:14px;border:#f97e34 1px solid; height:35px; line-height:35px; text-align:center; background-color:#eb6b1d;color:#FFFFFF; }
	...
	.da_shang_daoju{padding-left: 5px;}
	.da_shang_daoju li{ width:68px; margin-left:5px; margin-top:10px; text-align:center; }
	.char_div_css{ line-height:20px !important; margin-top:4px !important;}
	.img_div_css{ margin-top:4px !important;}
	.ok_div{ position:absolute; margin-left:36px; z-index:1px; background:url(<%=request.getContextPath()%>/mobile/images/ok.png) no-repeat; width:30px; height:30px; }
	.da_shang_anzhi{margin-top:0px !important; font-size:14px;}
	.da_shang_textarea{border: #b7bec2 1px solid; height: 45px;margin-top: 20px;}
	.toupiao_css{background-color:#1a9bdc; display:block; float:left; width:80px; border-radius:4px; cursor:pointer; line-height:45px; text-align:center; color:#FFFFFF; font-family:"黑体"; font-size:14px; letter-spacing:3px;}
	.close_da_shang{background-color:#f3540e; display:block;float:left; margin-left:10px; width:80px; border-radius:4px; cursor:pointer; line-height:45px; text-align:center; color:#FFFFFF; font-family:"黑体"; font-size:14px; letter-spacing:3px;}
</style>
<div onClick="window.history.go(-1);" class="backGo_css">
	返回<span class="banck_en_css">BACK UP PAGE</span>
</div>
<div>
	  ...
	  <tr>
		<td valign="top" width="80">
			<div class="bangdan_css" id="fixed_div" style="position: fixed; width:80px;">
				<div style=" background:url(<%=request.getContextPath() %>/mobile/images/p_b.png) no-repeat #FFFFFF;">投推荐票</div>
				<div>我投月票</div>
				<div>我要催更</div>
				<div>打赏作品</div>
			</div>
		...
		<td valign="top" style="background-color:#FFFFFF;">
			<div style="padding:5px;">
				...
				<!--推荐票-->
				<div class="bangdan_items" style="display: block;">
					...
					<div>
						<textarea class="da_shang_textarea" id="tuijianContent" name="tuijianContent" style="width:100%;resize: none;" placeholder="说点推荐话吧..."></textarea>
					</div>
					<div>
						<span class="toupiao_css" onClick="daShang('tuijian','${param.novelId}','${loginUsers.id}','${loginUsers.memberMoney}',0,'${remainTuiJianPiao }')">投票</span>
						<span class="close_da_shang" onClick="closeDaShang()">关闭</span>
					</div>
				...
				<!--月票-->
				<div class="bangdan_items">
					<c:if test="${yuepiao eq 'yes' }">
						<div>这本书写的很好，是我喜欢的书，我要投月票：</div>
						<div>
							<textarea class="da_shang_textarea" id="yuepiaoContent" name="yuepiaoContent" style=" width:100%;resize: none;" placeholder="给作者打点打气吧..."></textarea>
						</div>
						<div>
						...
						<div>
							<span class="toupiao_css" onClick="daShang('yuepiao','${param.novelId}','${loginUsers.id}','${loginUsers.memberMoney}',0,${yuepiaoNum-yuepiaoYiTou })">投票</span>
							<span class="close_da_shang" onClick="closeDaShang()">关闭</span>
						</div>
						<div class="da_shang_tips">
				...
				<div class="bangdan_items">
					...
					<div style="padding-top: 5px;">
						催更票:<input type="text" id="cuiGengNum" name="cuiGengNum" value="1" onKeyUp="value=value.replace(/\D/g,'')" style="width:45px; height:25px; line-height:25px; padding-left:7px;"/>&nbsp;张
					...
					<div>
						<textarea class="da_shang_textarea" id="cuiGengContent" name="cuiGengContent" style=" width:100%;resize: none;" placeholder="给作者说点什么吧..."></textarea>
					</div>
					<div>
						<span class="toupiao_css" value="催更" onClick="daShang('cuiGeng','${param.novelId}','${loginUsers.id}','${loginUsers.memberMoney}',0)">催更</span>
						<span class="close_da_shang" onClick="closeDaShang()">关闭</span>
					</div>
					<div class="da_shang_tips">
				...
				<div class="bangdan_items">
					...
					<div>
						打赏:<input type="text" id="daShangMoney" name="daShangMoney" value="10" onKeyUp="value=value.replace(/\D/g,'')" style="width:45px; height:25px; line-height:25px; padding-left:7px;"/>&nbsp;安之币&nbsp;&nbsp;&nbsp;[亲，可以打赏比道具多的安之币打赏哦！]
					</div>
					<div>
					...
					<div>
						<span class="toupiao_css" value="立即打赏" onClick="daShang('daShang','${param.novelId}','${loginUsers.id}','${loginUsers.memberMoney}',0)">打赏</span>
						<span class="close_da_shang" onClick="closeDaShang()">关闭</span>
					</div>
					<div class="da_shang_tips">
