...
<html xmlns="http://www.w3.org/1999/xhtml,http://open.weibo.com/wb">
  <head>
	...
	<meta http-equiv="keywords" content="你是我的,novel_pojo.guanjianci"/>
	...
	<div class="main_css">
		...
		<div class="projects_main">
			<div class="title_book">
				<div class="title_book_one" onclick="window.location.href='<%=request.getContextPath()%>/novel/18044.jsp'" style="cursor: pointer;">你是我的</div>
				<div style="margin-top: 7px;">作者：<font class="tipsdex">卷枝</font></div>
				<div>
					<span >分类:<font class="tipsdex">现代言情</font></span>
					<span style="margin-left: 40px;">章节数:<font class="tipsdex">1章</font></span>
					<span style="margin-left: 40px;">最新更新时间:<font class="tipsdex">2016-04-10 10:09:13</font></span>
			...
			<div class="projects_liebiaoone">
				<div class='fen_juan_items'><div class='fen_juan_name'>第1卷 正文内容<span class='buyFenJuan'><a href='javascript:;' onclick="buyFenJuan('18182','1','0','0')">整卷购买</a></span></div><div class='chapter_div' id='chapter_div18182'></div></div>	
			</div>
		</div>
	</div>
	<div class="foot_css">
