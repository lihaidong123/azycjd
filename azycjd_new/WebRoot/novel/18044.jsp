...
<html xmlns="http://www.w3.org/1999/xhtml,http://open.weibo.com/wb">
  <head>
	...
	<meta http-equiv="keywords" content="你是我的,一见钟情,霸道,总裁,耽美,宠文"/>
	<meta http-equiv="description" content="你是我的,一见钟情,霸道,总裁,耽美,宠文"/>
  ...
  <body id="top_banner" style="padding:0px; margin:0px; background:url(${sessionShouyetoubu})  center 0px no-repeat #f0f0f0;">
	...
	<div class="main_css">
		...
		<div style="position:absolute; top:1120px; margin-left:745px;">
			<div class="self_btn" style="margin-left:50px;margin-top:15px;"><a href="<%=request.getContextPath()%>/novel/18044/index.jsp">立刻阅读</a></div>
		</div>		
			...
			<div class="projects_head">
				<div class="head_youshang">
					...
					<div class="head_hang" style="margin-top:25px;">
						<div style="font-size:40px;font-weight: bolder;font-family:'黑体';">你是我的</div>
					</div>
					...
					<div class="youshang_second" id="zuopin">
						...
						<!-- <div class="head_hang" style="clear:both;padding-top:7px;">
							<div>作者：</div>
							<div class="author_name" onclick="javascript:window.open('<%=request.getContextPath()%>/anzhiauthor/findAnzhiAuthorByDetail.do?anzhiauthorId=46773')">卷枝</div>
						</div> -->
						<div class="head_hang" style="clear:both;padding-top:7px;">
							<div>小说作者：</div>
							<div style='cursor: pointer;font-weight: bold;' onclick="javascript:window.open('<%=request.getContextPath()%>/anzhiauthor/findAnzhiAuthorByDetail.do?anzhiauthorId=46773')">卷枝</div>
						</div>
						...
						<div class="head_hang" style="clear:both;padding-top:7px;">
							<div>总点击：</div>
							<div id="zongdianji">22</div>
						</div>
						<div class="head_hang" style="clear:both;padding-top:7px;">
							<div>总字数：</div>
							<div id="zongzishu">0</div>
						</div>
						<div class="head_hang" style="clear:both;padding-top:7px;">
							<div>更新时间：</div>
							<div id="gengxinshijian">2016-04-10 10:09:13</div>
						</div>
						<div class="head_hang" style="clear:both;padding-top:7px;">
							<div>是否签约：</div>
							<div style="color:red;">未签约</div>
						</div>
						<div class="head_hang" style="clear:both;padding-top:7px;">
							<div>发表方式：</div>
							<div>【独家首发】</div>
					...
					<div class="youshang_second" id="zuojia" style="display:none;">
							...
							<div class="head_hang" style="clear:both;padding-top:7px;">
								<div>作者简介：</div>
								<div><span style="padding-left:40px;"></span>卷枝是一个18岁的女孩纸…150cm的身高，身高是硬伤…最讨厌麻烦事，最讨厌无理取闹的人，最爱吃的，梦想是去旅游，然后吃吃吃吃~～(￣▽￣～)(～￣▽￣)～</div>
							</div>
				...
				<div>
					<div class="head_zuoxia">
						<div class="zuoxia_hang">
							...
							<div id="shoucangbenshu" style="display: none;"><a href="javascript:;" onclick="multifunction(this,'${loginUsers.id}','18044',1,'你是我的')">收藏本书</a></div>
						...
						<div id="da_shang_button" class="zuoxia_hang">
							<div class="tuijian_div" onclick="daShangNovel(0,'${loginUsers.id}','18044','你是我的')"></div>
							<div class="yuepiao_div" onclick="daShangNovel(1,'${loginUsers.id}','18044','你是我的')"></div>
							<div class="cuigeng_div" onclick="daShangNovel(2,'${loginUsers.id}','18044','你是我的')"></div>
							<div class="dashang_div" onclick="daShangNovel(3,'${loginUsers.id}','18044','你是我的')"></div>
						</div>
					</div>
...
顾城:“我们...好久没有运动了... ....”
古白:“啥？”
     “是哦，我好久没看你运动了，城，你是想做俯卧撑了？”
     “你怎么不说话了？”...
						</div>
						<div class="youxia_er">
							<div>标签:一见钟情,霸道,总裁,耽美,宠文</div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="projects_mafan">
				...
				<div style="width:290px;height:280px;" id="fensibang">
					...
					<div style="margin-top: 10px; padding-bottom:30px; font-size: 12px;"><a href="javascript:window.open('<%=path %>/anzhinovel/moreFenSi.do?novelId=18044')">更多...</a></div>
				</div>
		    ...
		    <div class="shupingqu">
		    	<div class="shupingqu_two">
		    		<div class="shupingqu_title">你是我的书评区<span class="look_more_comment" onclick="window.open('<%=request.getContextPath() %>/anzhicomment/findMyAnzhiCommentAllIndex.do?novelId=18044')">更多评论</span><span id="commentLiuYanTotalNum" class="commentTotal">总共0条</span></div>
			    	<!-- <div>
		    ...
		    <div class="read_pl_more">
		    	<div class="look_more_comment" onclick="window.open('<%=request.getContextPath() %>/anzhicomment/findMyAnzhiCommentAllIndex.do?novelId=18044')">查看更多评论...</div>
					...
					<table width="100%">
						<tr>
							<td valign="top" width="14%" align="center">
								<div style="background:url(images/7_p_3.png) no-repeat 5px 4px; padding-left:28px; font-size:16px;">评论<span style="font-size:13px; padding-left:7px;">共0条</span></div>
								...
								<div style="background-color:#FFFFFF; width:100%; border-radius:5px; padding-top:10px;">
									<div style=" margin:0 auto;width:95%;">
										...
										<div class="shupin_css_foot" style="overflow:auto; padding-top:10px; padding-bottom:10px;">
											...
											<div class="addCommentDiv" onclick="saveComment(this,18044,'${loginUsers.id}',0,0)">提交书评</div>
										</div>
