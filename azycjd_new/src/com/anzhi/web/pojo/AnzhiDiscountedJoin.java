...
public class AnzhiDiscountedJoin extends FatherPojo implements java.io.Serializable {
	public AnzhiDiscountedJoin(){
	}
	public AnzhiDiscountedJoin setValues(Object[] obj) {
		AnzhiDiscountedJoin model=new AnzhiDiscountedJoin();
		model.setId(obj[0]==null?0:Integer.parseInt(obj[0].toString()));
		model.setDiscountedId(obj[1]==null?0:Integer.parseInt(obj[1].toString()));
	...
	private Integer discountedId;
	public void setDiscountedId(Integer discountedId){
		this.discountedId=discountedId;
	}
	public Integer getDiscountedId(){
