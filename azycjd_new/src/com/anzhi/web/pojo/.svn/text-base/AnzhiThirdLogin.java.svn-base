...
public class AnzhiThirdLogin extends FatherPojo implements java.io.Serializable {
	public AnzhiThirdLogin(){
	}
	public AnzhiThirdLogin setValues(Object[] obj) {
		AnzhiThirdLogin model=new AnzhiThirdLogin();
		model.setId(obj[0]==null?0:Integer.parseInt(obj[0].toString()));
		model.setMemberId(obj[1]==null?0:Integer.parseInt(obj[1].toString()));
		model.setThirdLoginPid(obj[2]==null?"":obj[2].toString());
		model.setThirdLoginType(obj[3]==null?0:Integer.parseInt(obj[3].toString()));
	...
	private String thirdLoginPid;
	public void setThirdLoginPid(String thirdLoginPid){
		this.thirdLoginPid=thirdLoginPid;
	}
	public String getThirdLoginPid(){
		return this.thirdLoginPid;
	}
